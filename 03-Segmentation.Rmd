...
```{r, create-raster, results=FALSE, message=FALSE, warning=FALSE}
# load packages
library(terra)
library(meanShiftR)
library(tidyverse)
...
```{r, run-segmentation, results=FALSE, message=FALSE, warning=FALSE}
...
```{r, compare-datasets1, results=FALSE, message=FALSE, warning=FALSE}
# load base imagery
...
```{r, compare-datasets2, results=FALSE, message=FALSE, warning=FALSE}
