# **7** Case Study: French-Severn Forest {-#fsf}
...
## **7.1** Segmentation {-#fsf71}

### **7.1.1** Run Algorithm {-#fsf711}

```{r, fsf711, results=FALSE, message=FALSE, warning=FALSE, fig.width=18, fig.height=12}
##################################
...
### **7.1.2** Results: Summary Statistics {-#fsf712}

Polygon size statistics:

```{r, fsf7121, results='asis', message=FALSE, warning=FALSE, fig.width=18, fig.height=12}
###########################################
...
```{r, fsf7122, results='asis', message=FALSE, warning=FALSE, fig.width=18, fig.height=12}
# Area and Perim
...
```{r, fsf7123, results='asis', message=FALSE, warning=FALSE, fig.width=18, fig.height=12}
# Mean Shape Index
...
```{r, fsf7124, results='asis', message=FALSE, warning=FALSE, fig.width=18, fig.height=12}
# R2
...
### **7.1.3** Results: Distribution Plots {-#fsf713}

Polygon size:

```{r, fsf7131, results=FALSE, message=FALSE, warning=FALSE, fig.width=18, fig.height=12}
...
```{r, fsf7132, results=FALSE, message=FALSE, warning=FALSE, fig.width=18, fig.height=12}
...
## **7.2** Imputation Over FRI {-#fsf72}

### **7.2.1** Run Algorithm {-#fsf721}

```{r, fsf721, results=FALSE, message=FALSE, warning=FALSE, fig.width=18, fig.height=12}
##################################
### INSTALL PACKAGES IF NEEDED ###
##################################
...
lidar_imp <- c('avg' = 'D:/ontario_inventory/FSF/ALS/zmean.img',
...
dat_fri_scr %<>% select(OPI_ID, AGE2018, avg,
                        rumple, pcum8, sd,
                        b6, x, y, SP1, SP2, class3, class5)

# remove any polygons with missing values
# in imputation X-variables
dat_fri_scr <- left_join(dat_fri_scr %>% select(OPI_ID, AGE2018, avg,
                        rumple, pcum8, sd,
                        b6, x, y) %>% na.omit,
                        dat_fri_scr)
...
### **7.2.2** Results: Imputation Over FRI {-#fsf722}

Summary Stats:

```{r, fsf7221, results='asis', message=FALSE, warning=FALSE, fig.width=18, fig.height=12}
# round values
...
```{r, fsf7222, results='asis', message=FALSE, warning=FALSE, fig.width=18, fig.height=12}
...
## **7.3** Imputation from FRI to GRM {-#fsf73}

### **7.3.1** Run Algorithm  {-#fsf731}

```{r, fsf731, results=FALSE, message=FALSE, warning=FALSE, fig.width=18, fig.height=12}
...
### **7.3.2** Results: Imputation X-Variable Performance  {-#fsf732}

```{r, fsf732, results='asis', message=FALSE, warning=FALSE, fig.width=18, fig.height=12}
...
### **7.3.3** Results: Distribution of Age  {-#fsf733}

Spatial comparison:

```{r, fsf7331, results='asis', message=FALSE, warning=FALSE, fig.width=18, fig.height=12}
# load GRM polygons
poly_grm <- vect(grm)
...
```{r, fsf7332, results='asis', message=FALSE, warning=FALSE, fig.width=18, fig.height=12}
...
### **7.3.4** Results: Distribution of Species  {-#fsf734}

Spatial patterns of three functional group classification:

```{r, fsf7341, results='asis', message=FALSE, warning=FALSE, fig.width=18, fig.height=12}
...
```{r, fsf7342, results='asis', message=FALSE, warning=FALSE, fig.width=18, fig.height=12}
...
```{r, fsf7343, results='asis', message=FALSE, warning=FALSE, fig.width=18, fig.height=12}
...
```{r, fsf7344, results='asis', message=FALSE, warning=FALSE, fig.width=18, fig.height=12}
