...
# set parameters
in_name <- 'D:/ontario_inventory/segmentation/python/segments/segments_slic_70k_01_mask_short.tif'
out_name <- 'D:/ontario_inventory/segmentation/python/shp/segments_slic_70k_01_mask_short_add_pt.shp'
name <- 'slic_70k_01_mask_short'
...
# load input img
# mask <- rast('D:/ontario_inventory/segmentation/spl_stack_mask_wat_ucl_polytype.tif')
# mask <- values(mask[[1]])

# mask missing input locations in output segmentation
#num[is.na(mask)] <- NA

# put values back into img
# values(img) <- num
...
# save plot
ggsave(str_c('D:/ontario_inventory/segmentation/python/plots/', name, '.png'),
...
# save plot
ggsave(str_c('D:/ontario_inventory/segmentation/python/plots/', name, '_for.png'),
       width = 2100, height = 2100, units = 'px')
...
# save plot
ggsave(str_c('D:/ontario_inventory/segmentation/python/plots/', name, '_mask_wat_ucl.png'),
       width = 2100, height = 2100, units = 'px')
...
# save plot
ggsave(str_c('D:/ontario_inventory/segmentation/python/plots/', name, '_mask_wat_ucl_perim_area.png'),
       width = 2100, height = 2100, units = 'px')
...
# write df as csv
write.csv(out_df,
          file = str_c('D:/ontario_inventory/segmentation/python/tables/', name, '_table.csv'),
          row.names = F)
...
# save plot
ggsave('D:/ontario_inventory/segmentation/python/plots/all_interp.png',
       width = 2100, height = 2100, units = 'px')
...
# save plot
ggsave('D:/ontario_inventory/segmentation/python/plots/forested_interp.png',
       width = 2100, height = 2100, units = 'px')
...
# save plot
ggsave('D:/ontario_inventory/segmentation/python/plots/non_wat_ucl_interp.png',
       width = 2100, height = 2100, units = 'px')
...
# save plot
ggsave('D:/ontario_inventory/segmentation/python/plots/non_wat_ucl_interp_perim_area.png',
       width = 2100, height = 2100, units = 'px')
