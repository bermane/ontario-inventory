...
writeVector(poly_lidar2, filename = 'D:/ontario_inventory/imputation/distributions_for_only/vector/ms_10_10_100_for_only_imp_30_perc.shp')

# write dataframe with imputed data
write.csv(imp_lidar, file = 'D:/ontario_inventory/imputation/distributions_for_only/vector/ms_10_10_100_for_only_imp_30_perc.csv')
...
# write polygons with imputed data
writeVector(poly_imp, filename = 'D:/ontario_inventory/imputation/distributions_for_only/vector/fri_polygons_for_only_imp_30_perc.shp')

# write dataframe with imputed data
write.csv(imp_full, file = 'D:/ontario_inventory/imputation/distributions_for_only/vector/fri_polygons_for_only_imp_30_perc.csv')
...
ggplot() +
  ...
  scale_color_manual(name = "Dataset", values = c('FRI (Lor Height)' = '#CCBB44', 'LiDAR (Lor Height)' = '#AA3377',
                                                  ...
                                                  'FRI Imp (HT)' = '#228833'))
ggsave(filename = 'D:/ontario_inventory/imputation/distributions_for_only/height_for_only_30perc.png')
...
ggplot() +
  ...
  xlab("Height (m)") + ylab("Density") + 
  colscale_fri
ggsave(filename = 'D:/ontario_inventory/imputation/distributions_for_only/interp_height_for_only_30perc.png')
...
ggplot() +
  ...
  scale_color_manual(name = "Dataset", values = c('FRI (% 2m Rtn)' = '#CCBB44', 'LiDAR (% 2m Rtn)' = '#AA3377',
                                                  ...
                                                  'FRI Imp (CC)' = '#228833'))
ggsave(filename = 'D:/ontario_inventory/imputation/distributions_for_only/canopy_cover_for_only_30perc.png')
...
ggplot() +
  ...
  xlab("Cover (%)") + ylab("Density") + 
  colscale_fri
ggsave(filename = 'D:/ontario_inventory/imputation/distributions_for_only/interp_canopy_cover_for_only_30perc.png')
...
ggplot() +
  ...
  scale_color_manual(name = "Dataset", values = c('FRI (EFI gen)' = '#CCBB44', 'LiDAR (EFI gen)' = '#AA3377',
                                                  ...
                                                  'FRI Imp (BA)' = '#228833'))
ggsave(filename = 'D:/ontario_inventory/imputation/distributions_for_only/basal_area_for_only_30perc.png')
...
ggplot() +
  ...
  xlab(expression("Basal Area (m"^2*"/ha)")) + ylab("Density") + 
  colscale_fri
ggsave(filename = 'D:/ontario_inventory/imputation/distributions_for_only/interp_basal_area_for_only_30perc.png')
...
ggplot() +
  ...
  colscale_fri
ggsave(filename = 'D:/ontario_inventory/imputation/distributions_for_only/age_for_only_30perc.png')
...
# export as csv
write.csv(wg_freq, 
          file = 'D:/ontario_inventory/imputation/distributions_for_only/working_group_30_perc.csv', 
          row.names = F)
...
# write table
write.csv(rmse_df, file = 'D:/ontario_inventory/imputation/distributions_for_only/rmsd_30_perc.csv')
...
# write to csv
write.csv(accmat_wg_ext, file = 'D:/ontario_inventory/imputation/distributions_for_only/accmat_wg_30_perc.csv')
