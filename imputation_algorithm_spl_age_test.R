...
tar_vars <- c('HT', 'CC', 'BA', 'POLYTYPE', 'WG', 'AGE')
y <- dat[, tar_vars]
...
png('D:/ontario_inventory/imputation/test_imp_spl_efi/ht_spl_full_age.png', width = 480)
ggplot(imp_full) + 
...
png('D:/ontario_inventory/imputation/test_imp_spl_efi/cc_spl_full_age.png', width = 480)
ggplot(imp_full) + 
...
png('D:/ontario_inventory/imputation/test_imp_spl_efi/ba_spl_full_age.png', width = 480)
ggplot(imp_full) + 
...
png('D:/ontario_inventory/imputation/test_imp_spl_efi/age_spl_full_age.png', width = 480)
ggplot(imp_full) + 
...
# write table
write.csv(rmse_df, file = 'D:/ontario_inventory/imputation/test_imp_spl_efi/rmsd_spl_full_age.csv')
...
# write to csv
write.csv(accmat_pt_ext, file = 'D:/ontario_inventory/imputation/test_imp_spl_efi/accmat_pt_spl_full_age.csv')
...
# write to csv
write.csv(accmat_wg_ext, file = 'D:/ontario_inventory/imputation/test_imp_spl_efi/accmat_wg_spl_full_age.csv')
...
# compare input data and imputed data plots
png('D:/ontario_inventory/imputation/test_imp_spl_efi/ht_spl_age.png', width = 480)
plot(dat$HT, imp_fri$HT)
dev.off()

png('D:/ontario_inventory/imputation/test_imp_spl_efi/cc_spl_age.png', width = 480)
plot(dat$CC, imp_fri$CC)
dev.off()

png('D:/ontario_inventory/imputation/test_imp_spl_efi/ba_spl_age.png', width = 480)
plot(dat$BA, imp_fri$BA)
dev.off()

png('D:/ontario_inventory/imputation/test_imp_spl_efi/age_spl_age.png', width = 480)
...
# write table
write.csv(rmse_df, file = 'D:/ontario_inventory/imputation/test_imp_spl_efi/rmsd_spl_age.csv')
...
# write to csv
write.csv(accmat_pt_ext, file = 'D:/ontario_inventory/imputation/test_imp_spl_efi/accmat_pt_spl_age.csv')
...
# write to csv
write.csv(accmat_wg_ext, file = 'D:/ontario_inventory/imputation/test_imp_spl_efi/accmat_wg_spl_age.csv')
