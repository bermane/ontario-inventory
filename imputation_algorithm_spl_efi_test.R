...
# The model is applied in three different scenarios based on different ref vars: SPL, EFI, and ALL
# The model is used to impute nearest neighbor in the rest of the FRI as well as in the screened data
