...
# load filenames to read back in
gr_files <- list.files('D:/ontario_inventory/imputation/vanilla',
                       pattern = glob2rx('group3_comb_vars_chunk_*2023_02_28.csv'),
                       full.names = T)
...
# write out
write.csv(gr_top, 'D:/ontario_inventory/imputation/vanilla/gr3_top_2023_02_28.csv')
...
efi_vars <- c('lor', 'ba', 'qmdbh', 'dens',
          'agb', 'top_height', 'v_merch')
...
# write out
write.csv(gr_top, 'D:/ontario_inventory/imputation/vanilla/gr3_top_als_2023_02_28.csv')
...
# write out
write.csv(gr_top, 'D:/ontario_inventory/imputation/vanilla/gr3_top_efi_2023_02_28.csv')
