...
# because we want to calibrate the model to accurately predict forest struction and 
...
dat_1c <- dat[dat$num_uniq <= 2 & dat$perc_for >= .95,]
...
# write to disk
write.csv(dat_screen, file = 'D:/ontario_inventory/imputation/dat_screen_1bc_2apc_10perc_for.csv', row.names = F)

# save working image to speed up future changes
save.image('D:/ontario_inventory/imputation/photo_data_screening_for.RData')
